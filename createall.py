...
def create_test_script(base_file_name,method, endpoint, parameter=None,baseurl = 'https://petstore3.swagger.io/api/v3'):     
...
create_file(typescript='addtostepsscript',projectid='peet',userstoryid='storee',featurename = 'Finding the order using order id using GET API', scenarioname ='Get order by order id' ,endpoint ='store/order/2' , pointingattribute = 'orderid', method='GET',parameter_values='orderid')
...
create_file(typescript='addtostepsscript',projectid='peet',userstoryid='storee',featurename='get user by user name using GET API',scenarioname='get user by user name',endpoint = 'user/user1',pointingattribute='username', method = 'GET', parameter_values = 'username')
...
create_file(typescript='addtostepsscript',projectid='peet',userstoryid='storee',featurename = 'delete the order using order id using delete method', scenarioname ='delete order by order id' ,endpoint ='store/order/1' , pointingattribute = 'deleteorderid', method='DELETE',parameter_values='deleteorderid')
