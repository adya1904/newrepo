...
def createfile(typefile, base_file_name):  # create a file
    ...
    filename = "testcase_generator/" + filename
...
def create_file_final(typescript='testscript', baseurl="", projectid="1111", userstoryid="2222", method=None,
                      endpoint=None, parameter=None, contenttype=None, auth_type=None, parameter_values=None,
                      featurename='test feature', scenarioname='test scenario', pointingattribute=None, headers=None, auth=None,
                      featuresdir='features/'):
    print ('create_file_final : {},{},{},{},{},{},{},{},{}'.format(baseurl,typescript,projectid,userstoryid,featurename,scenarioname,endpoint,method,headers))
    
    pointingattribute = parameter_values
    s = ["createfeature","stepsscript"]
